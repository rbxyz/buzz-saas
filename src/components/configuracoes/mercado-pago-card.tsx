...
import { CreditCard, Shield, AlertCircle, CheckCircle2, Crown, Zap } from "lucide-react";
...
export function MercadoPagoCard() {
  ...
  const plans: Plan[] = [
    {
      ...
      type: "starter",
      price: 29.90,
      preapprovalPlanId: "SEU_ID_DO_PLANO_STARTER_AQUI",
      features: [
    ...
    },
    {
      ...
      type: "pro",
      price: 79.90,
      preapprovalPlanId: "SEU_ID_DO_PLANO_PRO_AQUI",
      features: [
  ...
  const handleCancelSubscription = async () => {
    try {
      ...
      // Implementar cancelamento da assinatura
      toast({
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          {connectionStatus?.success && (
            <Alert>
              ...
              <AlertDescription>
                Mercado Pago configurado e funcionando corretamente.
            ...
            {plans.map((plan) => (
              ...
              >
                ...
                <CardContent className="flex flex-1 flex-col justify-between">
                  ...
                  <div className="mt-6">
                    <SubscriptionButton planId={plan.preapprovalPlanId} />
                  </div>
                </CardContent>
              </Card>
            ))}
        ...
        <div className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              <strong>Pagamento Seguro:</strong> Todos os pagamentos são processados com segurança através do Mercado Pago.
